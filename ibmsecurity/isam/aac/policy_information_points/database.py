...
def update(isamAppliance, name, properties, attributes, description=None, new_name=None, type="Database", check_mode=False,
           force=False):
    """
...
def set(isamAppliance, name, properties, attributes, description=None, new_name=None, type="Database", check_mode=False,
        force=False):
    """
