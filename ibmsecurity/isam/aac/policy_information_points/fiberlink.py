...
def update(isamAppliance, name, properties, attributes=None, description=None, new_name=None, type="FiberLink MaaS360",
           check_mode=False, force=False):
    """
...
def set(isamAppliance, name, properties, attributes=None, description=None, new_name=None, type="FiberLink MaaS360",
        check_mode=False, force=False):
    """
