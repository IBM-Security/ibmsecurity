...
def add(isamAppliance, id, stanza_id, check_mode=False, force=False):
    ...
    if force is True or _check(isamAppliance, id, stanza_id, ret_obj) is False:
...
def delete(isamAppliance, id, stanza_id, check_mode=False, force=False):
    ...
    if force is True or _check(isamAppliance, id, stanza_id, ret_obj) is True:
        if check_mode is True:
            return isamAppliance.create_return_object(changed=True)
        else:
...
def _check(isamAppliance, id, stanza_id, ret_obj):
    """
