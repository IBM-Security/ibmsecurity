...
def modify(isamAppliance, modify_key, modify_value, force=False):
    """
    modify default value
    """
    
    return isamAppliance.invoke_put("Modify default value", "/wga/kerberos/config/libdefaults/" + modify_key,
                                     {
                                         "value": modify_value
                                     })
