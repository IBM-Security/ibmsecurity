...
def add (isamAppliance, local_dns_value, realm_name, force=False):
    """
    Add kerberos domain
    """
    return isamAppliance.invoke_post("Add Kerberos Realm", "/wga/kerberos/config/domain_realm/",
                                            {
                                                 "name": local_dns_value,
                                                 "value": realm_name
                                            })
